...
export class AvatarComponent implements OnInit {
    ...
    set src(src: String) {
        ...
        this.img.onload = () => {
            var data = this._getImgBase64(this.img);
    ...
    private _getImgBase64(img: HTMLImageElement): String {
